<template>
  <form class="nobottommargin" @submit.prevent>
    ...
    <div class="col_half">
      ...
      <input type="text" id="delivery-form-building" name="delivery-form-building" class="form-control" :class="{error: false}" required />
    </div>
    <div class="col_half col_last">
      <label for="delivery-form-flat">{{ $trans('checkout.delivery_step.form_flat') }}</label>
      <input type="text" id="delivery-form-flat" name="delivery-form-flat" class="form-control" :class="{error: false}" required />
      <span v-if="false" class="help-block">{{ $trans('checkout.delivery_step.nova_poshta_courier.validation.flat') }}</span>
    </div>
    <div class="col_half">
